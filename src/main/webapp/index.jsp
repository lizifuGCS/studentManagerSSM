...
<html>
  ...
  <body class="easyui-layout" style="background-color: #00bbee">
  	 <!-- 顶部 --> 
    <div data-options="region:'north',split:true" style="height:80px;background-color: #00bbee " >
    	
    	<!-- logo -->
    	<div id="logo">
    		<img src="images/timg.jpg" width="300" height="80"/>
    	</div>

		<div id="text" style="position: center;h">
			<h1>欢迎来到攻城狮之家</h1>
		</div>
    	<!-- 登录用户信息 -->
    ...
    <div data-options="region:'center'" style="padding:5px;background:#eee;">
    	<div id="tt" class="easyui-tabs" style="width:500px;height:250px;" data-options="fit:true">   
		    <div title="起始页" style="padding:20px;display:none;">
				<div id="logo2">
					<h1 >欢迎来到攻城狮之家：欢迎回家，主人：GSC-李</h1>
					<img src="images/timg.jpg" width="750" height="500"/>
				</div>
		    </div>     
		</div>  
    </div> 
